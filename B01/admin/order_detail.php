            ...
            try {
                ...
                if ($current_status == 0 && $new_status == 1) {
                    ...
                    foreach ($items as $item) {
                        ...
                        $log_sql = "INSERT INTO tracuutonkho (SP_id, TrangThai_NhapXuat, SoLuong, MaThamChieu_NhapXuat) VALUES (?, 'Xuất', ?, ?)";
                    ...
                    if ($px_result->num_rows > 0) {
                        ...
                        foreach ($items as $item) {
                            ...
                            $log_sql = "INSERT INTO tracuutonkho (SP_id, TrangThai_NhapXuat, SoLuong, MaThamChieu_NhapXuat) VALUES (?, 'Hủy đơn', ?, ?)";
                            $log_stmt = $conn->prepare($log_sql);
                                ...
                                <tr class="hover:bg-gray-50 transition" data-ward="<?php echo htmlspecialchars($order['Quan'] ?? ''); ?>">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex items-center justify-center gap-1">
                                            <a href="order_detail.php?id=<?php echo $order['DonHang_id']; ?>" class="text-blue-500 hover:text-blue-700 p-1" title="Xem chi tiết"><i class="fas fa-eye"></i></a>
                                            <?php if ($isLocked): ?>
    ...
    <div id="trackModal" class="modal">
        <div class="track-modal-content">
            ...
            <div class="p-6" id="trackModalContent">
                <div class="text-center py-12"><i class="fas fa-spinner fa-spin text-3xl"></i><p>Đang tải...</p></div>
            </div>
            ...
            searchInput.addEventListener('input', function() {
                if (hasSQLInjection(this.value)) {
                    ...
                    if (!warning) {
                        ...
                        warning.id = 'searchWarning';
                        warning.className = 'text-red-500 text-xs mt-1';
                        warning.innerHTML = '<i class="fas fa-shield-alt"></i> Phát hiện ký tự không an toàn!';
