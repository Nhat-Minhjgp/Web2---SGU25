                        ...
                        <div id="searchHeader" class="hidden items-center justify-between py-2">
                            <div class="flex-1 relative">
                                ...
                                <div class="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
                                    <button
                                        class="w-9 h-9 flex items-center justify-center text-gray-500 hover:text-red-600 transition-colors">
                                ...
                                <div id="searchSuggestions"
                                    class="custom-scrollbar absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-lg hidden z-50">
