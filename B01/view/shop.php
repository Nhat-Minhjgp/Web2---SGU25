...
<head>
    ...
    <style>
        ...
        .price-separator { color: #9ca3af; font-weight: 500; }
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <div id="wrapper" class="min-h-screen flex flex-col">
        ...
        <main>
            <div class="container mx-auto px-4 py-6 md:py-8">
                <!-- Active Filters Tags -->
                <?php if (isset($_GET['danhmuc']) || isset($_GET['thuonghieu']) || isset($_GET['min_price']) || isset($_GET['max_price'])): ?>
                <div class="mb-4">
                    ...
                    <div class="active-filters">
                        <?php if (isset($_GET['danhmuc']) && is_array($_GET['danhmuc'])): ?>
                            ...
                            <div class="filter-tag">
                                ...
                                <button onclick="removeSingleFilter('danhmuc', '<?php echo $slug; ?>')"><i class="fas fa-times text-xs"></i></button>
                            </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <?php if (isset($_GET['thuonghieu']) && is_array($_GET['thuonghieu'])): ?>
                            ...
                            <div class="filter-tag">
                                ...
                                <button onclick="removeSingleFilter('thuonghieu', '<?php echo $slug; ?>')"><i class="fas fa-times text-xs"></i></button>
                            </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        ...
                        <div class="filter-tag">
                            ...
                            <button onclick="removeFilter('price')"><i class="fas fa-times text-xs"></i></button>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <div class="filter-section">
                                    ...
                                    <div class="price-input-group mb-4">
                                        <div class="flex-1">
                                            ...
                                            <input type="text" id="price-min" class="price-input w-full" value="<?php echo number_format($min_price, 0, ',', '.'); ?>" placeholder="0₫">
                                        </div>
                                        <span class="price-separator pt-5">-</span>
                                        <div class="flex-1">
                                            <label class="text-xs text-gray-500 mb-1 block">Đến</label>
                                            <input type="text" id="price-max" class="price-input w-full" value="<?php echo number_format($max_price, 0, ',', '.'); ?>" placeholder="50.000.000₫">
                                        </div>
                                    </div>
                                    <button type="button" id="apply-filter" class="w-full bg-red-600 hover:bg-red-700 text-white py-3 rounded-lg text-sm font-medium transition shadow-md shadow-red-200">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-4">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <div class="text-sm text-gray-600">
                                    ...
                                    <span class="font-medium text-gray-900"><?php echo $offset + 1; ?>-<?php echo min($offset + $limit, $total_products); ?></span>
                                    <?php else: ?>
                                    <span class="font-medium text-gray-900">0</span>
                                    <?php endif; ?>
                                    trong <span class="font-medium text-gray-900"><?php echo $total_products; ?></span> kết quả
                                </div>
                        ...
                        <div class="lg:hidden mb-4">
                            <button id="open-mobile-filter-btn" class="w-full bg-white border border-gray-300 rounded-xl py-3 px-4 flex items-center justify-center gap-2 hover:bg-gray-50 transition shadow-sm">
                                <i class="fas fa-filter text-red-600"></i>
                                <span class="font-medium">Bộ lọc sản phẩm</span>
                                <?php if (isset($_GET['danhmuc']) || isset($_GET['thuonghieu']) || isset($_GET['min_price'])): ?>
                                    ...
                                    <div class="relative">
                                        <?php if ($product['SoLuongTon'] > 0): ?>
                                            ...
                                            <div class="absolute top-2 right-2 z-10">
                                                <span class="bg-red-500 text-white text-xs px-2 py-1 rounded-full font-medium">-<?php echo $discount; ?>%</span>
                                            </div>
                                            <?php endif; ?>
                                        <?php else: ?>
                                        <div class="absolute top-2 left-2 z-10">
                                            <span class="bg-gray-500 text-white text-xs px-2 py-1 rounded-full font-medium">Hết hàng</span>
                                        </div>
                                        <?php endif; ?>
                        ...
                        <div class="flex justify-center mt-8">
                            <div class="flex items-center gap-1">
                                <a href="<?php echo buildFilterUrl(['page' => $page - 1]); ?>" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-300 bg-white hover:bg-gray-50 hover:border-red-300 transition <?php echo ($page <= 1) ? 'pointer-events-none opacity-50' : ''; ?>">
                                    <i class="fas fa-chevron-left text-sm"></i>
                                </a>
                                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                    <?php if ($i == $page): ?>
                                    <span class="w-10 h-10 flex items-center justify-center rounded-lg bg-red-600 text-white font-medium shadow-md shadow-red-200"><?php echo $i; ?></span>
                                    <?php elseif ($i == 1 || $i == $total_pages || ($i >= $page - 2 && $i <= $page + 2)): ?>
                                    <a href="<?php echo buildFilterUrl(['page' => $i]); ?>" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-300 bg-white hover:bg-gray-50 hover:border-red-300 transition">
                                        <?php echo $i; ?>
                                    </a>
                                    ...
                                    <?php endif; ?>
                                <?php endfor; ?>
                                <a href="<?php echo buildFilterUrl(['page' => $page + 1]); ?>" class="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-300 bg-white hover:bg-gray-50 hover:border-red-300 transition <?php echo ($page >= $total_pages) ? 'pointer-events-none opacity-50' : ''; ?>">
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-8 text-center">
                            ...
                            <p class="text-gray-500 mb-4">Không có sản phẩm nào phù hợp với bộ lọc của bạn.</p>
                            <a href="shop.php" class="inline-block px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium shadow-md shadow-red-200">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function openMobileFilter() {
            // Clone desktop content to mobile
        ...
        function applyFilter() {
            ...
            // Get multiple categories (checkboxes with name="danhmuc[]")
            ...
            // Get multiple brands (checkboxes with name="thuonghieu[]")
