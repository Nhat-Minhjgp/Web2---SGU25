...
<div class="container mx-auto px-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div class="grid grid-cols-4 gap-2">
            ...
            <button class="border-2 <?php echo $index === 0 ? 'border-red-600' : 'border-gray-200'; ?> rounded overflow-hidden hover:border-red-600 thumbnail-btn"
        ...
        <div class="flex items-center gap-4 mb-4 text-sm text-gray-600">
            ...
            <div class="flex items-center">
                ...
                <span>Thương hiệu: <strong><?php echo htmlspecialchars($product['Ten_thuonghieu']); ?></strong></span>
            </div>
            <?php endif; ?>
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <span class="text-3xl font-bold text-red-600"><?php echo formatPrice($product['GiaBan']); ?></span>
            <?php if ($discount > 0): ?>
                <span class="text-lg text-gray-400 line-through mb-1"><?php echo formatPrice($product['GiaNhapTB']); ?></span>
                <span class="bg-red-500 text-white text-xs px-2 py-1 rounded-full">-<?php echo $discount; ?>%</span>
            <?php endif; ?>
            </div>
            <div class="text-sm <?php echo $product['SoLuongTon'] > 0 ? 'text-green-600' : 'text-red-600'; ?> mt-2 flex items-center">
            <i class="fas fa-<?php echo $product['SoLuongTon'] > 0 ? 'check-circle' : 'times-circle'; ?> mr-1"></i>
        ...
        <form class="mt-auto space-y-4" method="POST" action="cart.php">
            ...
            <div class="flex items-center border border-gray-300 rounded">
                ...
                <input type="number" name="quantity" id="quantity" value="1" min="1" max="<?php echo $product['SoLuongTon']; ?>"
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            ...
            <div>
                ...
                <span class="ml-2 font-medium"><?php echo htmlspecialchars($product['SanPham_id']); ?></span>
            </div>
            <div>
                <span class="text-gray-500">Danh mục:</span>
                <span class="ml-2 font-medium"><?php echo htmlspecialchars($product['Ten_danhmuc'] ?? 'N/A'); ?></span>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-sm mb-2 relative aspect-square">
            ...
            <div class="absolute top-2 right-2 z-10">
                <span class="bg-red-500 text-white text-xs px-2 py-1 rounded-full">-<?php echo $related_discount; ?>%</span>
            </div>
            <?php endif; ?>
        ...
        <div class="flex items-center gap-2">
            ...
            <?php if ($related_discount > 0): ?>
            <div class="text-gray-400 text-xs line-through"><?php echo formatPrice($related['GiaNhapTB']); ?></div>
            <?php endif; ?>
        </div>
        </div>
        <?php endwhile; ?>
